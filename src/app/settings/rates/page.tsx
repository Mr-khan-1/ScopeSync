...
export default function RatesSettingsPage() {
  ...
  return (
    <div className="space-y-12 max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-8 duration-1000 relative">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-[800px] h-[300px] bg-primary/10 blur-[100px] md:blur-[150px] rounded-full pointer-events-none -z-10 mix-blend-screen opacity-50" />
